                ...
                <div class="row row-cols-md-2 row-cols-1  align-items-center">
                    ...
                    <div class="col">
                        <div class="image__with--text__content">
                            <h2 class="image__with--text__title mb-18">Most Talented Builders Architects Drone.</h2>
                            <p class="image__with--text__desc mb-25">Beyond more stoic this along goodness this sed wow manatee mongos flusterd impressive man farcrud opened inside owin punitively wasteful telling spransac coldly spokeles.</p>
                            ...
                            <div class="image__with--text__content--footer d-flex"> 
                                ...
                                <p class="image__with--text__content--footer__desc">
                                    YEARS SINCE WE ESTABLISHED - <br /> EXPERIENCE & STILL A GROWING <br /> PROTFOLIO DAY BY DAY!
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                    <div class="col">
                        <div class="about__content">
                            <h2 class="about__content--title mb-18">We Have This Builders Easy integrative.</h2>
                            <div class="about__content--step mb-25">
                                <p class="about__content--desc mb-20">Beyond more stoic this along goodness this sed wow manatee mongos flusterd impressive man farcrud opened inside owin punitively wasteful telling spransac coldly spokeles.</p>
                                <ul class="mb-20">
                                ...
                                <p class="about__content--desc style2">Beyond more stoic this along goodness this sed wow flusterd impressive</p>
                            </div>
